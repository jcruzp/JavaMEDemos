...
//#endif
		...
		userTimelineCommand = new Command("Me", Command.SCREEN, 12);
		addCommand(userTimelineCommand);
		publicTimelineCommand = new Command("Everyone", Command.SCREEN, 13);
...
//			break;
    ...
    private void setSelectCommand(Command readCommand) {
        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    }

    private void addCommand(Command readCommand) {
        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    }
