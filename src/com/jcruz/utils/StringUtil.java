...
//            Log.error("Error while removing HTML: " + e.toString());
     ...
     * @return
     */
    public static String[] formatMessage(String[] message, int width, String font) {
...
//                }
     ...
     */
    public static String[] chopStrings(String origional, String separator, String font, int width) {
